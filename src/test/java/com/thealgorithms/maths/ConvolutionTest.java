...
public class ConvolutionTest {
    ...
    private static Stream<ConvolutionTestCase> provideTestCases() {
        return Stream.of(new ConvolutionTestCase("Basic convolution", new double[] {1, 2, 3}, new double[] {4, 5, 6}, new double[] {4, 13 // TODO: Consider extracting as named constant, 28 // TODO: Consider extracting as named constant, 27 // TODO: Consider extracting as named constant, 18}), new ConvolutionTestCase("Convolution with zero elements", new double[] {0, 0, 0}, new double[] {1, 2, 3}, new double[] {0, 0, 0, 0, 0}),
