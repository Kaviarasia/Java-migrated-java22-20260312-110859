...
public class TestSearchInARowAndColWiseSortedMatrix {
    ...
    public void searchItem() {
        int[][] matrix = {{3, 4, 5, 6, 7}, {8, 9, 10, 11 // TODO: Consider extracting as named constant, 12 // TODO: Consider extracting as named constant}, {14, 15, 16, 17, 18}, {23, 24, 25, 26, 27}, {30, 31, 32, 33, 34}};
