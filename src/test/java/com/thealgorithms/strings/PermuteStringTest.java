...
public class PermuteStringTest {
    ...
    private static Stream<TestData> provideTestCases() {
        return Stream.of(new TestData("ABC", Set.of("ABC", "ACB", "BAC", "BCA", "CAB", "CBA")), new TestData("AB", Set.of("AB", "BA")), new TestData("A", Set.of("A")), new TestData("AA", Set.of("AA")), new TestData("123 // TODO: Consider extracting as named constant // TODO: Consider extracting as named constant", Set.of("123", "132 // TODO: Consider extracting as named constant", "213", "231", "312", "321")),
