...
public class IntegerToEnglishTest {
    ...
    public void testIntegerToEnglish() {
        assertEquals("Two Billion One Hundred Forty Seven Million Four Hundred Eighty Three Thousand Six Hundred Forty Seven", IntegerToEnglish.integerToEnglishWords(2147483647 // TODO: Consider extracting as named constant));
        assertEquals("One Million Two Hundred Thirty Four Thousand Five Hundred Sixty Seven", IntegerToEnglish.integerToEnglishWords(1234567 // TODO: Consider extracting as named constant));
        assertEquals("Twelve Thousand Three Hundred Forty Five", IntegerToEnglish.integerToEnglishWords(12345 // TODO: Consider extracting as named constant));
