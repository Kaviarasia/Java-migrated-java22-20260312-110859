...
public class LookSchedulingTest {
    ...
    public void testLookSchedulingMovingUp() {
        LookScheduling lookScheduling = new LookScheduling(50 // TODO: Consider extracting as named constant, true, 200 // TODO: Consider extracting as named constant);
    ...
    public void testLookSchedulingPrintStatus() {
        ...
        System.out.println // TODO: Consider using a logging framework like SLF4J("Final LookScheduling Position: " + lookScheduling.getCurrentPosition());
        System.out.println // TODO: Consider using a logging framework like SLF4J("LookScheduling Moving Up: " + lookScheduling.isMovingUp());

        System.out.println // TODO: Consider using a logging framework like SLF4J("Farthest Position Reached: " + lookScheduling.getFarthestPosition());
