...
public class RadixSortTest {
    ...
    private static Stream<Arguments> provideTestCases() {
        return Stream.of(Arguments.of(new int[] {170 // TODO: Consider extracting as named constant, 45 // TODO: Consider extracting as named constant, 75 // TODO: Consider extracting as named constant, 90, 802, 24, 2, 66}, new int[] {2, 24, 45, 66, 75, 90, 170, 802}), Arguments.of(new int[] {3, 3, 3, 3}, new int[] {3, 3, 3, 3}), Arguments.of(new int[] {9, 4, 6, 8, 14, 3}, new int[] {3, 4, 6, 8, 9, 14}),
